...
return [
    ...
    'provider' => 'vendor', // He cambiado 'cloud' a 'vendor' para usar los archivos locales que ya reparamos
     ...
     */
    'languages' => [
        // 'es' => 'https://cdn.jsdelivr.net/npm/tinymce-i18n@24.7.2/langs6/es.min.js', // Comentado temporalmente por error 404 en CDN
    ],
